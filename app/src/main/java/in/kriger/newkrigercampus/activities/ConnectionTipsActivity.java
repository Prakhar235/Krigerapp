...
public class ConnectionTipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String post_tips = getResources().getString(R.string.your_ideas_worth_spreading_connection);
        tips_text.setText(Html.fromHtml(post_tips));

        TextView tips_text2 =  findViewById(R.id.tips_text2);
        String why_post_tips = getResources().getString(R.string.whom_connection_guidelines);
        tips_text2.setText(Html.fromHtml(why_post_tips));

        TextView tips_text3 =  findViewById(R.id.tips_text3);
        String how_post_tips = getResources().getString(R.string.how_connection_guidelines);
