...
public class GroupLikeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_like_list);
        ...
        String grp_id=getIntent().getExtras().get("grp_id").toString();
        ...
        //Set Recyclerview
        Query likesRef = KrigerConstants.group_post_likeRef.child(grp_id).child(post_id);
    ...
    public void onBackPressed() {
        ...
        intent.putExtra("grp_id", getIntent().getExtras().get("grp_id").toString());
