...
import in.kriger.newkrigercampus.adapters.PostSearchAdapter;
...
public class PostSearch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new PostSearchAdapter(post_list,getContext(),group_posts);
    ...
    public void startSearch(String text){
        ...
        childUpdates.put("/index","firebase3");
        childUpdates.put("/type","post");
        childUpdates.put("/body/query/query_string/default_field","text");
                    ...
                    if (dataSnapshot.child("hits").child("total").getValue().toString().equals("0")){
                        ...
                        searching.setVisibility(View.GONE);
                           ...
                           for (DataSnapshot childsnapshot : dataSnapshot.child("hits").child("hits").getChildren()) {
                               if (childsnapshot.child("_source").child("text").exists()) {
